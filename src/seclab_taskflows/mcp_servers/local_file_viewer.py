...
LINE_LIMIT_FOR_FETCHING_FILE_CONTENT = int(os.getenv("LINE_LIMIT_FOR_FETCHING_FILE_CONTENT", "1000"))

FILE_LIMIT_FOR_LIST_FILES = int(os.getenv("FILE_LIMIT_FOR_LIST_FILES", "100"))
