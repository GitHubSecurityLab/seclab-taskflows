...
class ApplicationIssue(Base):
    ...
    def __repr__(self):
        return (
            f"<ApplicationIssue(id={self.id}, repo={self.repo}, "
...
class AuditResult(Base):
    ...
    def __repr__(self):
        return (
            f"<AuditResult(id={self.id}, repo={self.repo}, has_vulnerability={self.has_vulnerability}, has_non_security_error={self.has_non_security_error}, "
...
class EntryPoint(Base):
    ...
    def __repr__(self):
        return (
            f"<EntryPoint(app_id={self.app_id}, file={self.file}, user_input={self.user_input}, "
